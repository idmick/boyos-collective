...
describe('page structured-data regressions', () => {
  it('keeps the Soundsystem social preview image and service areas', () => {
    const source = readPage('pages/soundsystem.js')
    ...
    expect(source).toContain("image: 'https://www.boyoscollective.nl/images/og/boyos-soundsystem.jpg'")
  ...
  it('keeps the Summer Jam offer date and performer schema mapping', () => {
    const source = readPage('pages/wonderland/summer-jam.js')
